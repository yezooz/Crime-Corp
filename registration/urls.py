...
# from crims.registration.views import activate
# from crims.registration.views import register
# from crims.registration.forms import RegistrationFormUniqueEmail

urlpatterns = patterns('',
                       url(r'^login/$', 'crims.main.views.preview.register', name='auth_login'),
                       url(r'^logout/$', 'crims.main.views.index.logout', name='auth_logout'),
